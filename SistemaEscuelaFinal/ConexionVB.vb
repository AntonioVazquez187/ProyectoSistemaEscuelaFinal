Module ConexionVB
    ...
    Public conn As New SqlClient.SqlConnection("data source=DESKTOP-3AORFGT; initial catalog=SistemaEscuela2; integrated security= SSPI; persist security info= false; trusted_connection = yes;")
